...
print(f'Searching YouTube for the search term {search_keyword}...')

#### search for the search term on YouTube
# Result will be displayed in html and we will use the urllib.request to get this
html = urllib.request.urlopen("https://www.youtube.com/results?search_query=" + search_keyword.replace(" ", "_"))
